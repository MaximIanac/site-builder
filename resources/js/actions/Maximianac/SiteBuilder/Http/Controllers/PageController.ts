...
/**
* @see \Maximianac\SiteBuilder\Http\Controllers\PageController::index
 * @see packages/maximianac/site-builder/src/Http/Controllers/PageController.php:22
 * @route '/cp/pages'
 */
...
/**
* @see \Maximianac\SiteBuilder\Http\Controllers\PageController::create
 * @see packages/maximianac/site-builder/src/Http/Controllers/PageController.php:32
 ...
 * @see packages/maximianac/site-builder/src/Http/Controllers/PageController.php:48
 * @route '/cp/pages'
 */
 ...
 * @see packages/maximianac/site-builder/src/Http/Controllers/PageController.php:60
 * @route '/cp/pages/{page}'
 */
 ...
 * @see packages/maximianac/site-builder/src/Http/Controllers/PageController.php:83
 * @route '/cp/pages/{page}'
 */
 ...
 * @see packages/maximianac/site-builder/src/Http/Controllers/PageController.php:102
 * @route '/cp/pages/{page}'
 */
