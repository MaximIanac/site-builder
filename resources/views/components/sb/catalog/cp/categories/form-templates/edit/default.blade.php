@props([
    'categories' => [],
    'properties' => [],
    'category' => null, // Static data for the category being edited
])
...
@php
    ...
    $categoryData = [
        ...
        'parent_id' => null,
        'properties' => [1, 3] // IDs of attached properties
    ];
@endphp
...
<script>
    function categoryManager() {
        return {
            selectedCategory: @json($category->parent_id ?? old('parent_id') ?? ''),
            inheritedProperties: [],
            addedProperties: @json($categoryData['properties'] ?? []),
            ...
            init() {
                ...
                // Convert property IDs to full objects
